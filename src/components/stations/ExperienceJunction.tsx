    ...
    >
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="exp-timeline relative">
          {/* Main vertical track */}
          <div
            className="exp-main-track absolute left-1/2 -translate-x-1/2 top-0 bottom-0 w-[3px] rounded-full hidden md:block"
            style={{
              background:
          ...
          <div
            className="exp-main-track absolute left-5 top-0 bottom-0 w-[3px] rounded-full md:hidden"
            style={{
              background:
                "linear-gradient(to bottom, var(--warm-orange), var(--steel-gray), var(--warm-orange))",
            }}
              ...
              return (
                ...
                >
                  ...
                  <div className="hidden md:grid md:grid-cols-[1fr_auto_1fr] md:items-start md:gap-8">
                    {/* Left side */}
                    {isLeft ? (
                      <div className="exp-card flex justify-end">
                        <ExperienceCard
                          exp={exp}
                  ...
                  <div className="md:hidden flex items-start gap-4 pl-10">
                    {/* Switch dot (on the track) */}
                    <div
                      className="exp-switch-dot absolute left-[12px] w-5 h-5 rounded-full border-[3px] z-10 mt-1"
                      style={{
                        borderColor: accentColor,
                        background: "var(--bg-primary)",
                    ...
                    {/* Branch line */}
                    <div
                      className="exp-branch-line absolute left-[26px] top-[18px] h-[3px] w-5"
                      style={{
                        background: accentColor,
          ...
          <div className="flex justify-center md:justify-center mt-8">
            ...
            />
            <div
              className="w-4 h-4 rounded-full md:hidden"
              style={{
                background: "var(--warm-orange)",
                boxShadow: "0 0 16px rgba(232, 114, 42, 0.4)",
                position: "absolute",
...
function ExperienceCard({
  ...
  return (
    <div
      className="glass rounded-xl p-5 sm:p-6 max-w-md transition-all duration-300 hover:-translate-y-1"
      style={{
    ...
    >
      ...
      {/* Highlights */}
      <div
        className={`space-y-2 ${align === "right" ? "text-right" : "text-left"}`}
      >
